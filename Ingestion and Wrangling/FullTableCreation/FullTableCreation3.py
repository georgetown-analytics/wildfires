...
For team:
    This version code was used to create MergeTable3_FirmsAndBigWfigs2Round.csv and MergeTable4_FirmsAndBigWfigs1Round.csv
...
"""
The MODIS dataframe now has a mergable field of the time and place 'date_loc'
...
"""
Both dataframes should be ready for merging on the key

Merging on the date + location key.
"""

print('Merging the dataframes...')
dfDiscovered = df_FIRMS.merge(df_wfigsbig, left_on='date_loc', right_on='disc_date_loc', how='inner') #creates df of only dsetected areas
dfMerged = df_FIRMS.merge(df_wfigsbig, left_on='date_loc', right_on='disc_date_loc', how='left') #creates df of both 
